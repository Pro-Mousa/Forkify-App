...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","core-js/modules/web.immediate.js":"bzsBv","./model.js":"3QBkH","./views/recipeView.js":"3wx5k","./views/searchView.js":"kbE4Z","./views/resultsView.js":"kBQ4r","regenerator-runtime/runtime":"f6ot0","./views/paginationView.js":"7NIiB"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
const getJSON = async function(url) {
    try {
        const res = await Promise.race([
            (fetch(url), timeout((0, _configJs.TIMEOUT_SEC)))
        ]);
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
      ...
      <figure class="recipe__fig">
        ...
        <div class="recipe__ingredients">
          ...
          ${this._data.ingredients.map(this._generateMarkupIngredents).join('')}
          </ul>
        </div>
    ...
    _generateMarkupIngredents(ing) {
        return `
    <li class="recipe__ingredient">
    <svg class="recipe__icon">
      <use href="${0, _iconsSvgDefault.default}#icon-check"></use>
    </svg>
    <div class="recipe__quantity">${ing.quantity ? (0, _fracty.fracty)(ing.quantity) : ''}</div>
...
},{"url:../../img/icons.svg":"fd0vu","./View.js":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f6ot0":[function(require,module,exports,__globalThis) {
/**
